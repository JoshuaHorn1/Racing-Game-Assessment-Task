"""Welcome Screen Component - Version 4
...
the program.
- Fixed the glitch where the buttons weren't being centred in the screen (this
was done through a function called 'center_x'.
- Changed the placement and size of the buttons.
- Changed the font and size of the button text.
"""
