"""Artificial Car Component - Version 7
...
- Fixed error where AI cars aren't correctly placed on the lanes.
- Changed AI car speed from the bottom.
- Added a cooldown so that AI cars can only spawn again after a short delay.
- Adjusted user y-position.
"""
