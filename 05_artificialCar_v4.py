"""Artificial Car Component - Version 4
...
- Retrying with a new approach: create car class and generate_car() function.
"""
...
class Car:
    def __init__(self, direction, velocity, lane, y_pos, colour):
...
def generate_car():
    ...
    if create_car <= 5:
        ...
        new_car = Car(direction, velocity, lane, y_pos, colour)
        cars.append(new_car)
