...
A component to keep track of whatever the highest score is, and then display
it on the welcome screen before the game starts.
- Created a text file to store the highscore
- Created a function to constantly check if the users score is greater than
the highscore, and if it is, to overwrite the old highscore with the user's
new highscore.
"""
