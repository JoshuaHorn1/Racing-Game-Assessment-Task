"""Resetting Game Component - Version 1
A component to display a game over screen after the user crashes, and then ask
them whether or not they want to continue. If they do, then reset the game and
start the game loop over.
- Created a function to display a game over screen and ask the user if they
want to play again.
- Increased the rate at which the background speeds up.
- Adjusted the speed of AI cars going up.
"""
...
def game_over_screen():
    ...
    while True:
        ...
        # Display final score
        final_score_text = HIGHSCORE_FONT.render(f"Your Score: {score}",
                                                 True, WHITE)
...
# Create a mask of the user's car (for pixel perfect collision)
user_border_mask = pygame.mask.from_surface(user_car)
