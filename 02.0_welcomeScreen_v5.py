"""Welcome Screen Component - Version 5
...
the program.
- Allowed the user to exit the program by closing the window.
- If the "Start Game" button is pressed, the game loop will start.
