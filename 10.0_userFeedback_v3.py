"""User Feedback Component - Version 3
A component where I get end-user feedback and then trial their suggestions to
incorporate into my code.
- Added a display which shows all of the different car colour options.
- Adjusted the location of the colour selection arrows.
- Added an arrow pointing to the currently selected car colour.
- Adjusted the colours of the arrow buttons.
- Adjusted the text of the arrow buttons to be "<<<<<" and ">>>>>".
"""
